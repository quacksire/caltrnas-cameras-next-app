    ...
    return (
        <Card className={'max-w-350 max-h-100 m-3 w-100'} key={crypto.randomUUID()}>
            ...
            <CardContent className={'justify-center w-full'}>
                ...
                {hasLive && (
                    <MediaPlayer streamType={'ll-live'} controls muted className={"width-[320px] height=[260px] rounded-md shadow-md shadow-gray-500 bg-foreground"} src={camera.imageData.streamingVideoURL}>
                        <MediaProvider/>
                    </MediaPlayer>
